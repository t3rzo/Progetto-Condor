...
$turni = [
    '1' => ['titolo' => '1&deg; Turno', 'badge' => 'Kids / Cadetti', 'orario' => 'Luned&igrave;, Mercoled&igrave;, Venerd&igrave; | 17:00 - 18:30', 'elite' => false, 'atleti' => []],
    '2' => ['titolo' => '2&deg; Turno', 'badge' => 'Cadetti / Junior', 'orario' => 'Luned&igrave;, Mercoled&igrave;, Venerd&igrave; | 18:30 - 20:00', 'elite' => false, 'atleti' => []],
    '3' => ['titolo' => '3&deg; Turno', 'badge' => 'Senior', 'orario' => 'Luned&igrave;, Mercoled&igrave;, Venerd&igrave; | 20:00 - 21:30', 'elite' => false, 'atleti' => []],
    '4' => ['titolo' => 'Allenatori/Tecnici', 'badge' => 'Maestro', 'orario' => '', 'elite' => true, 'atleti' => []]
];
function getAtletiByTurno($db, $turno) {
    $turno = mysqli_real_escape_string($db, $turno);
    $query = "SELECT nome, cognome, numero_tesseramento, grado_cintura FROM atleti WHERE turno = '$turno' ORDER BY cognome ASC";
...
<form method="POST" action="aggiungi_atleta.php" class="compact-form">
<div class="form-row">
...
<option value="1">1° Turno (Kids/Cadetti)</option>
<option value="2">2° Turno (Cadetti/Junior)</option>
<option value="3">3° Turno (Senior)</option>
<option value="4">Allenatori/Tecnici</option>
</select>
<select name="grado_cintura" required>
...
<button type="submit" class="btn btn-primary" style="width: 100%;">Aggiungi atleta</button>
</form>
</section>
